...
public final class BrokerConstants {
    ...
    public static final String DB_Auth_sqlUsername="authenticator.db_sqlusername";
    public static final String DB_Auth_sqlpassword="authenticator.db_sqlpassword";
    public static final String DB_Auth_MaxPoolSize="authenticator.db_sqlMaxPoolSize";
    public static final String DB_Auth_minPoolSize="authenticator.db_sqlminPoolSize";
    public static final String DB_Auth_InitialPoolSize="authenticator.db_sqlInitialPoolSize";
    public static final String DB_Auth_MaxStatements="authenticator.db_sqlMaxStatements";
    public static final String DB_Auth_MaxIdleTime="authenticator.db_sqlMaxIdleTime";
    public static final String DB_AUTHACL_Read_QUERY = "ACL.db.read.query";
    public static final String DB_AUTHACL_Write_QUERY = "ACL.db.write.query";
